    ...
    public OpenAPI springDocOpenAPI() {
        return new OpenAPI()
                .info(new Info().title("Controller REST API")
                        .version(version)
                        .contact(new Contact().name("suxinhang")
                                .email("soniccloudorg@163.com"))
                        .description("Folder of Sonic Cloud Real Machine Platform")
                        .termsOfService("https://github.com/suxinhang/sonic/blob/main/LICENSE")
                        .license(new License().name("AGPL v3")
                                .url("https://github.com/suxinhang/sonic/blob/main/LICENSE")));
    }
}
